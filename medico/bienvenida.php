...
.usuario{
    font-size:1.15rem; color:#0284C7; font-weight:600; margin-bottom:18px;
}
...
.btn{ background:#0EA5E9; box-shadow:0 8px 20px rgba(14,165,233,.28); }
...
<i class="bi bi-person-badge"></i> Dr(a). <?php echo $_SESSION['nombre']; ?>
